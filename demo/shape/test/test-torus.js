...
test('Torus - evaluateVec3 (0, 0, 0) minor=.25, major=1.0', function(t) {
  ...
  var torus = new Torus(1, .25, 0, 0, 0);
...
test('Torus - bounds', function(t) {
  ...
  t.deepEqual((new Torus(1, .5, 0, 0, 0)).computeAABB(), [
    [-1.5, -.5, -1.5],
    [ 1.5,  .5,  1.5],
  ], 'bounds around origin');

  t.deepEqual((new Torus(1, .5, 0, 0, 0)).translate(0, 10, 0).computeAABB(), [
    [-1.5, 9.5, -1.5],
    [ 1.5, 10.5,  1.5],
  ], 'bounds around (0, 10, 0)');

  t.deepEqual((new Torus(1, .5, 0, 0, 0)).translate(2, 10, 0).computeAABB(), [
    [ 0.5, 9.5, -1.5],
    [ 3.5, 10.5,  1.5],
  ], 'bounds around (2, 10, 0)');

  t.deepEqual((new Torus(2, .5, 0, 0, 0)).translate(2, 10, 0).computeAABB(), [
    [ -0.5, 9.5, -2.5],
    [ 4.5, 10.5,  2.5],
